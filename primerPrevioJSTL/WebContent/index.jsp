...
<section id="team" class="pb-5">
    <div class="container">
        ...
        <jsp:useBean id="Dao" class="dao.tiendaDao" scope="request"></jsp:useBean>
        <div class="row">
           <c:forEach var="tienda" items="${Dao.list()}">
                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="${tienda.imagen}" alt="card image"></p>
